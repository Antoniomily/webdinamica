...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	var typed = new Typed('.type', {
        strings: ['<span><i class="fas fa-check"></i></span> ALIMENTOS', 
                '<span><i class="fas fa-check"></i></span> ACCESORIOS',
                '<span><i class="fas fa-check"></i></span> SERVICIOS'],
